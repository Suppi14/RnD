...
#ifndef MY_CHAINIDSOLVER_VERESHCHAGIN_HPP
#define MY_CHAINIDSOLVER_VERESHCHAGIN_HPP
...
private:
    ...
    void constraint_calculation(const JntArray& beta,const Jacobian& alfa);
    /**
...
private:
    ...
    struct segment_info
    {
        ...
        Matrix6d Projection; //Projection matrix
        Matrix6d Projection_tilde; //
